...
fn compile_cuda() {
    ...
    let cuda_src = PathBuf::from("assets/cuda/kernels/my_struct_kernel.cu");
    let ptx_file = "assets/cuda/compiled/my_struct_kernel.ptx";
    ...
    let bindings = bindgen::Builder::default()
        ...
        // bindings for.
        .header("assets/cuda/includes/bindgen.h")
